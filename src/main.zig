...
pub fn main(init: std.process.Init) !void {
    ...
    var cli = CLIBuilder.init(allocator, init, "zio", "0.4.2", "A blazing-fast, cross-platform file system utility built in Zig — designed for efficiency, reliability, and simplicity.");
    defer cli.deinit();
